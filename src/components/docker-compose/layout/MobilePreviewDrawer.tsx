    ...
    <Drawer>
      <DrawerTrigger asChild>
        <Button type="button" className="w-full justify-between lg:hidden">
          <span>{t('common:workspace.mobilePreviewTrigger')}</span>
          <Eye className="size-4" />
        </Button>
      </DrawerTrigger>
      <DrawerContent className="max-h-[92vh]">
        <DrawerHeader className="border-b border-border/60">
          <DrawerTitle>{t('common:workspace.mobilePreviewTitle')}</DrawerTitle>
          <DrawerDescription>{t('common:workspace.mobilePreviewDescription')}</DrawerDescription>
        </DrawerHeader>
